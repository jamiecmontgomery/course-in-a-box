...
Changing the text to see what happens. My favorite things:
* **[Cheese](/modules/setup/getting-started/)** - Get your instance of Course-in-a-Box up and running
* **[Dogs](/modules/content/markdown-and-media)** -  Update the course structure and add your copy & media
* **[Beach](/modules/customize/favicon)** - Add some (optional) finishing touches
